...
subtitle: "Automation with Homebrew, dotfiles, and macOS defaults"
date: last-modified
category: "[config, cli, macos]"
number-sections: false
image: media/welcome-to-mac.png
---
...
![The new Mac Mini](media/mac-mini-closeup2.png)

![Initial setup process completed, ready to hit `./bootstrap.sh`](media/welcome-to-mac.png)
:::
...
![Symlinked dotfiles<br>_This screenshot shows Stow in action, where configs in my home directory (left side) are pointing to their actual location in my dotfiles directory (right side)_.](media/screenshot-dotfiles-symlinks-1.png){#screenshot-stow-in-action}

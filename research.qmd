...
::: {.research-project}
### Testing the Gradient Predictions of the Monocentric City Model in Addis Ababa [<i class="bi bi-file-pdf" aria-hidden="true"></i>]({{< var paper-addis >}}){aria-label="PDF"} [<i class="bi bi-github" aria-hidden="true"></i>]({{< var code-addis >}}){aria-label="Code on GitHub"}
...
::: {.research-project}
### The impact of COVID-19 on real estate markets in Germany. --- German Economic Review [<i class="bi bi-file-pdf" aria-hidden="true"></i>]({{< var paper-covid >}}){aria-label="PDF"} [<i class="bi bi-github" aria-hidden="true"></i>]({{< var code-covid >}}){aria-label="Code on GitHub"}
...
::: {.research-project}
### Geographic Constraints and the Housing Supply Elasticity in Germany --- [*Ruhr Economic Papers #1003* <i class="bi bi-file-pdf" aria-hidden="true"></i>]({{< var paper-elasticity >}}) --- latest version [<i class="bi bi-file-pdf" aria-hidden="true"></i>]({{< var paper-elasticity-latest >}}){aria-label="PDF"} [<i class="bi bi-github" aria-hidden="true"></i>]({{< var code-elasticity >}}){aria-label="Code on GitHub"}
...
::: {.research-project}
### Trends in Contemporary International Migration of Ethiopia PanAfrican Journal of Governance and Development (PJGD), 1(2), 30-60. [<i class="bi bi-file-pdf" aria-hidden="true"></i>]({{< var paper-migration >}}){aria-label="PDF"}
